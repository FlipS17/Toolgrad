...
-- CreateTable
CREATE TABLE "_PromotionToCategory" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_PromotionToCategory_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_PromotionToCategory_B_index" ON "_PromotionToCategory"("B");
...
-- AddForeignKey
ALTER TABLE "_PromotionToProduct" ADD CONSTRAINT "_PromotionToProduct_A_fkey" FOREIGN KEY ("A") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_PromotionToProduct" ADD CONSTRAINT "_PromotionToProduct_B_fkey" FOREIGN KEY ("B") REFERENCES "Promotion"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_PromotionToCategory" ADD CONSTRAINT "_PromotionToCategory_A_fkey" FOREIGN KEY ("A") REFERENCES "Category"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_PromotionToCategory" ADD CONSTRAINT "_PromotionToCategory_B_fkey" FOREIGN KEY ("B") REFERENCES "Promotion"("id") ON DELETE CASCADE ON UPDATE CASCADE;
